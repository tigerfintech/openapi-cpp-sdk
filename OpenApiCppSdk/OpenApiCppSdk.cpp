// OpenApiCppSdk.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
void signTest() {
	unsigned char plainText[2048 / 8] = "biz_content={\"lang\":\"en_US\",\"market\":\"ALL\"}&charset=UTF-8&method=market_state&sign_type=RSA&tiger_id=1&timestamp=2019-06-06 13:51:54&version=2.0"; //key length : 2048
	...
	int encryptedRet = sha1RSASign.sha1Encrypt(plainText, strlen((char*)plainText), privateKey, encrypted, &encrypted_length);
