...
/* @@protoc_insertion_point(class_definition:tigeropen.push.pb.PositionData) */ {
 public:
  ...
  PositionData* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "tigeropen.push.pb.PositionData"; }
