...
class OrderTransactionData final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tigeropen.push.pb.OrderTransactionData) */ {
 public:
  inline OrderTransactionData() : OrderTransactionData(nullptr) {}
  ~OrderTransactionData() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR OrderTransactionData(::google::protobuf::internal::ConstantInitialized);

  inline OrderTransactionData(const OrderTransactionData& from)
      : OrderTransactionData(nullptr, from) {}
  ...
  OrderTransactionData* New(::google::protobuf::Arena* arena = nullptr) const final {
