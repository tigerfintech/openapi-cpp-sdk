...
const ::uint32_t
    TableStruct_TickData_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_TickData_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_TickData_2eproto = {
    false,
    false,
    267,
...
inline PROTOBUF_NDEBUG_INLINE TickData_Tick::Impl_::Impl_(
    ...
    const Impl_& from, const ::tigeropen::push::pb::TickData_Tick& from_msg)
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
            ::google::protobuf::Message::GetDeleteImpl<TickData_Tick>(),
            ::google::protobuf::Message::GetNewImpl<TickData_Tick>(),
            ::google::protobuf::Message::GetClearImpl<TickData_Tick>(), &TickData_Tick::ByteSizeLong,
                &TickData_Tick::_InternalSerialize,
#endif  // PROTOBUF_CUSTOM_VTABLE
            PROTOBUF_FIELD_OFFSET(TickData_Tick, _impl_._cached_size_),
            false,
        },
        &TickData_Tick::kDescriptorMethods,
        &descriptor_table_TickData_2eproto,
        nullptr,  // tracker
};
const ::google::protobuf::MessageLite::ClassData* TickData_Tick::GetClassData() const {
...
const ::_pbi::TcParseTable<3, 7, 0, 56, 2> TickData_Tick::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::tigeropen::push::pb::TickData_Tick>(),  // to_prefetch
...
// @@protoc_insertion_point(message_clear_start:tigeropen.push.pb.TickData.Tick)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* TickData_Tick::_InternalSerialize(
          ...
          const TickData_Tick& this_ = static_cast<const TickData_Tick&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
        ::uint8_t* TickData_Tick::_InternalSerialize(
            ::uint8_t* target,
            ::google::protobuf::io::EpsCopyOutputStream* stream) const {
          const TickData_Tick& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          ...
          // string partCode = 7;
          if (!this_._internal_partcode().empty()) {
            const std::string& _s = this_._internal_partcode();
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        ::size_t TickData_Tick::ByteSizeLong(const MessageLite& base) {
          const TickData_Tick& this_ = static_cast<const TickData_Tick&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
...
void TickData_Tick::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
inline PROTOBUF_NDEBUG_INLINE TickData::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::tigeropen::push::pb::TickData& from_msg)
...
const ::google::protobuf::MessageLite::ClassDataFull
    TickData::_class_data_ = {
        ::google::protobuf::Message::ClassData{
            ...
            &TickData::MergeImpl,
#if defined(PROTOBUF_CUSTOM_VTABLE)
            ::google::protobuf::Message::GetDeleteImpl<TickData>(),
...
const ::google::protobuf::MessageLite::ClassData* TickData::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(_class_data_.tc_table);
  return _class_data_.base();
}
...
const ::_pbi::TcParseTable<2, 4, 1, 47, 2> TickData::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::tigeropen::push::pb::TickData>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // string source = 4;
    {::_pbi::TcParser::FastUS1,
...
void TickData::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_TickData_2eproto),
         ::std::false_type{});
