...
Contract stock_contract(const utility::string_t symbol, const utility::string_t currency, const utility::string_t local_symbol = U(""),
...
Contract option_contract(const utility::string_t symbol, const utility::string_t expiry, double strike, const utility::string_t right,
                         ...
                         long contract_id = 0);
Contract option_contract(const utility::string_t identifier, long multiplier = 100, const utility::string_t currency = U("USD"));

Contract future_contract(const utility::string_t symbol, const utility::string_t currency, const utility::string_t expiry = U(""),
